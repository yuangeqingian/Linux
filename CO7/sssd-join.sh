...
#AllowUsers  root adm-bgcit yli153  hsun5 zwang77 xfeng5
#AllowGroups orgunit_oilfield_ems_technology adm-bgcit root  orgunit_oilfield_shared_services_it-mobile_test
